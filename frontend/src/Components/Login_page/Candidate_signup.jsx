    ...
    const handleRegister = async (e) => {
        ...
        try {
            const response = await axios.post(
                'http://127.0.0.1:8000/employee/candidateregister/',
                formData,
                {
                    headers: {
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-96">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <input
                        ...
                        required
                    />
                    {error && <p className="text-red-500 mb-4">{error} <Link to="/Candidate_Login" className="text-blue-500">Sign in</Link></p>}
                ...
                <p className="mt-4">Already have an account? <Link to="/Candidate_Login" className="text-blue-500">Sign in</Link></p>
            </div>
        </div>
    );
};
